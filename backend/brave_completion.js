...
module.exports = function registerBraveCompletion({app,db,helpers}){
  ...
  affordable.forEach((x,i)=>ins.run('brave-affordable-'+(i+1),'ADMIN','UNIQUE BRAVE','uniquebrave',x[0],x[1],`Affordable everyday item from the UNIQUE BRAVE catalogue. Starting price is NGN ${x[2]}.`,x[2],0,'pay_on_delivery',x[3],'',0,'active',25,25));
