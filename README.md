...
## UNIQUE BRAVE 2.6 Marketplace Upgrade
This release keeps UNIQUE BRAVE Marketplace separate from BRAVE World/games and separate from AI video-generation projects.
Added:
- Personal Business Centre
- Creative Studio with saved designs
- Growth Centre
- Saved Listings
- Reputation view
- Customer Care shortcut
- Admin Platform Command Centre
- Admin oversight of user-to-user marketplace chats and recorded BRAVE AI conversations
- Admin database diagnostics, maintenance, session cleanup, reindex and protected backup actions
- Versioned migration for business-platform tables
- Node.js 22+/24-compatible SQLite adapter using Node's built-in `node:sqlite`
- Existing marketplace, products, services, orders, receipts, profiles, timeline, plans, wallet foundation, workshops, admin and authentication preserved.
